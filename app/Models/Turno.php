...
class Turno extends Model
{
    ...
    protected $casts = [
        ...
        'tanque_super_pulgadas' => 'decimal:2',
        'tanque_regular_pulgadas' => 'decimal:2',
        'tanque_diesel_pulgadas' => 'decimal:2',
        'tanque_super_galones' => 'decimal:2',
        'tanque_regular_galones' => 'decimal:2',
        'tanque_diesel_galones' => 'decimal:2'
    ];
