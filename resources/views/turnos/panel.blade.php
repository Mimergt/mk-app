                        ...
                        @foreach($bombas as $nombreBomba => $bombaData)
                            <div x-data="{ bombaExpanded: false }" 
                                ...
                                <div x-show="bombaExpanded" 
                                     ...
                                     style="display: none;">
                                    <form action="{{ route('turnos.bomba.guardar-grupo', $nombreBomba) }}" method="POST" class="p-3">
                                        @csrf
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 mb-4">
                                            @foreach(['Super', 'Regular', 'Diesel', 'CC'] as $tipo)
                                                @if(isset($bombaData['combustibles'][$tipo]))
                                                    ...
                                                    <div class="bg-white/10 rounded-xl p-3 border border-white/10 shadow-sm">
                                                        ...
                                                        <div class="space-y-2">
                                                            <div>
                                                                ...
                                                                <div class="bg-gray-700/50 rounded-lg p-2 text-center">
                                                                    <span class="text-xs font-mono font-bold">{{ number_format($combustible['galonaje'], 2) }}</span>
                                                                    <span class="text-xs text-white/60 ml-1">gal</span>
                                                                </div>
                                                                <div class="text-xs text-white/50 mt-1 text-center">
                                                                    {{ \Carbon\Carbon::parse($bombaData['updated_at'])->format('d/m/Y H:i') }}
                                                                </div>
                                                            </div>
                                                            
                                                            <div class="bg-red-500/10 border-2 border-orange-400/50 rounded-lg p-3">
                                                                <label class="block text-sm font-bold text-orange-300 mb-2 text-center">
                                                                ...
                                                                <input type="number" 
                                                                       ...
                                                                       min="{{ $combustible['galonaje'] + 0.01 }}"
                                                                       class="w-full px-3 py-3 bg-orange-400/20 border-2 border-orange-400/70 rounded-lg text-white font-bold placeholder-orange-200/70 focus:outline-none focus:ring-4 focus:ring-orange-400/50 focus:border-orange-300 font-mono text-sm text-center shadow-lg transition-all duration-200 hover:bg-orange-400/30"
                                                                       placeholder="{{ number_format($combustible['galonaje'] + 1, 2) }}" />
