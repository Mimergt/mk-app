    ...
    <div class="mb-8">
        <div class="sm:hidden">
            ...
            <select id="tabs" name="tabs" class="block w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500 shadow-sm">
                <option value="gastos" {{ $activeTab === 'gastos' ? 'selected' : '' }}>💰 Gastos</option>
                                ...
                                <div class="mt-4 p-3 bg-purple-100 dark:bg-purple-900/30 rounded-lg">
                                    <div class="flex items-start space-x-2">
                                        ...
                                        <div class="text-xs text-purple-700 dark:text-purple-300">
                                            <strong>Información:</strong> Los precios de venta se calculan automáticamente del promedio de todas las ventas registradas en el mes.
                                        </div>
                                    </div>
                                </div>
                            </div>
